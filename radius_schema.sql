...
--
-- Host: 168.148.62.15    Database: radius
-- ------------------------------------------------------
...
--
-- Table structure for table `authen_session`
--

DROP TABLE IF EXISTS `authen_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `authen_session` (
  `zoneid` int(11) NOT NULL,
  `sessionid` varchar(100) NOT NULL,
  `authenticated_via` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `authen_session_info`
--

DROP TABLE IF EXISTS `authen_session_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `authen_session_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `zoneid` int(11) DEFAULT NULL,
  `sessionId` varchar(255) DEFAULT NULL,
  `authenticated_via` varchar(100) DEFAULT NULL,
  ...
  `acc_session_timeout` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=27092 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dictionary` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9718 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `node` (
  ...
  `nbs` longtext NOT NULL COMMENT 'ROBIN: neighbor list',
  ...
  `routes` longtext NOT NULL COMMENT 'ROBIN: route to nearest gateway',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `mac` (`mac`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='node database';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `operators_acl` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=252 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `operators_acl_files` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=140 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `person` (
  ...
  `passwd_md5` varchar(255) DEFAULT NULL,
  ...
  `alb_show` tinyint(1) DEFAULT NULL,
  `facebook` varchar(100) DEFAULT NULL,
  `hidden` tinyint(1) DEFAULT NULL,
  `addr` varchar(150) DEFAULT NULL,
  `denied` tinyint(1) DEFAULT NULL,
  `quit` tinyint(1) DEFAULT NULL,
  `edocument_level` varchar(10) DEFAULT NULL,
  `edocument_hospcode` varchar(5) DEFAULT NULL,
  `edocument_active` varchar(1) DEFAULT 'Y',
  `privilege` varchar(100) DEFAULT NULL,
  `cdc` varchar(20) DEFAULT NULL,
  `cdc_group` varchar(10) DEFAULT NULL,
  `covid` varchar(10) DEFAULT NULL,
  `lineID` varchar(100) DEFAULT NULL,
  `list_ssj` varchar(5) DEFAULT NULL,
  `active` varchar(1) DEFAULT NULL,
  `comment` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`cid`) USING BTREE,
  KEY `cid` (`cid`,`passwd`) USING BTREE,
  KEY `hospcode` (`hospcode`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `person_radius`
--

DROP TABLE IF EXISTS `person_radius`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `person_radius` (
  `cid` varchar(15) NOT NULL,
  `name` varchar(50) NOT NULL,
  `surname` varchar(50) NOT NULL,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `after_person_insert` AFTER INSERT ON `person_radius` FOR EACH ROW BEGIN
  --
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `after_person_update` AFTER UPDATE ON `person_radius` FOR EACH ROW BEGIN
  -- 
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE TABLE `radcheck` (
  ...
  KEY `username` (`username`),
  KEY `value` (`value`)
) ENGINE=MyISAM AUTO_INCREMENT=2841 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `radcheck0`
--

DROP TABLE IF EXISTS `radcheck0`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `radcheck0` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(64) NOT NULL DEFAULT '',
  `attribute` varchar(64) NOT NULL DEFAULT '',
  `op` char(2) NOT NULL DEFAULT '==',
...
--
-- Table structure for table `radcheck1`
--

DROP TABLE IF EXISTS `radcheck1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `radcheck1` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(255) DEFAULT NULL,
  `attribute` varchar(64) NOT NULL DEFAULT '',
  `op` char(2) NOT NULL DEFAULT '==',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `username` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=2422 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `radcheck2`
--

DROP TABLE IF EXISTS `radcheck2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `radcheck2` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(64) NOT NULL DEFAULT '',
  `attribute` varchar(64) NOT NULL DEFAULT '',
  `op` char(2) NOT NULL DEFAULT '==',
...
) ENGINE=MyISAM AUTO_INCREMENT=2379 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `radcheck_20240723`
--

DROP TABLE IF EXISTS `radcheck_20240723`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `radcheck_20240723` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(64) NOT NULL DEFAULT '',
  `attribute` varchar(64) NOT NULL DEFAULT '',
  `op` char(2) NOT NULL DEFAULT '==',
...
--
-- Table structure for table `radcheck_20241007`
--

DROP TABLE IF EXISTS `radcheck_20241007`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `radcheck_20241007` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(64) NOT NULL DEFAULT '',
  `attribute` varchar(64) NOT NULL DEFAULT '',
  `op` char(2) NOT NULL DEFAULT '==',
  `value` varchar(253) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `username_2` (`username`,`value`),
  KEY `username` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=2422 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `radcheck_mirror`
--

DROP TABLE IF EXISTS `radcheck_mirror`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `radcheck_mirror` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(64) NOT NULL DEFAULT '',
  `attribute` varchar(64) NOT NULL DEFAULT '',
  `op` char(2) NOT NULL DEFAULT '==',
  `value` varchar(253) NOT NULL DEFAULT '',
  `tmp_passwd` varchar(25) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `username` (`username`(32)) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=1658 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `radpostauth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=165239 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2667 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `userinfo0`
--
...
--
-- Table structure for table `userinfo_20240723`
--

DROP TABLE IF EXISTS `userinfo_20240723`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `userinfo_20240723` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(128) DEFAULT NULL,
  `firstname` varchar(200) DEFAULT NULL,
  `lastname` varchar(200) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `username` (`username`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=2381 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'ipaddr','AAT-Client-Primary-DNS',NULL,NULL,'Alcatel',NULL,NULL,NULL,NULL),
...
(8326,NULL,'Ascend-Data-Svc','Switched-V110-192-56',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8327,NULL,'Ascend-Data-Svc','Switched-V110-384-56',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8328,NULL,'Ascend-Data-Svc','Switched-V110-24-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8329,NULL,'Ascend-Data-Svc','Switched-V110-48-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8330,NULL,'Ascend-Data-Svc','Switched-V110-96-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8331,NULL,'Ascend-Data-Svc','Switched-V110-192-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8332,NULL,'Ascend-Data-Svc','Switched-V110-384-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8333,NULL,'Ascend-Data-Svc','Switched-V110-24-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8334,NULL,'Ascend-Data-Svc','Switched-V110-48-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8335,NULL,'Ascend-Data-Svc','Switched-V110-96-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8336,NULL,'Ascend-Data-Svc','Switched-V110-192-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8337,NULL,'Ascend-Data-Svc','Switched-V110-384-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8338,NULL,'Ascend-Data-Svc','Switched-V110-24-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8339,NULL,'Ascend-Data-Svc','Switched-V110-48-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8340,NULL,'Ascend-Data-Svc','Switched-V110-96-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8341,NULL,'Ascend-Data-Svc','Switched-V110-384-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8342,NULL,'Ascend-Data-Svc','Switched-V110-192-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8343,NULL,'Ascend-Data-Svc','Switched-Pots',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8344,NULL,'Ascend-Data-Svc','Switched-ATM',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8345,NULL,'Ascend-Data-Svc','Switched-FR',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8346,NULL,'Ascend-Force-56','Force-56-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8347,NULL,'Ascend-Force-56','Force-56-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8348,NULL,'Ascend-PW-Lifetime','Lifetime-In-Days',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8349,NULL,'Ascend-PW-Warntime','Days-Of-Warning',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8350,NULL,'Ascend-PPP-VJ-1172','PPP-VJ-1172',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8351,NULL,'Ascend-PPP-VJ-Slot-Comp','VJ-Slot-Comp-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8352,NULL,'Ascend-Require-Auth','Not-Require-Auth',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8353,NULL,'Ascend-Require-Auth','Require-Auth',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8354,NULL,'Ascend-Token-Immediate','Tok-Imm-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8355,NULL,'Ascend-Token-Immediate','Tok-Imm-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8356,NULL,'Ascend-DBA-Monitor','DBA-Transmit',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8357,NULL,'Ascend-DBA-Monitor','DBA-Transmit-Recv',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8358,NULL,'Ascend-DBA-Monitor','DBA-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8359,NULL,'Ascend-FR-Type','Ascend-FR-DTE',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8360,NULL,'Ascend-FR-Type','Ascend-FR-DCE',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8361,NULL,'Ascend-FR-Type','Ascend-FR-NNI',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8362,NULL,'Ascend-FR-Link-Mgt','Ascend-FR-No-Link-Mgt',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8363,NULL,'Ascend-FR-Link-Mgt','Ascend-FR-T1-617D',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8364,NULL,'Ascend-FR-Link-Mgt','Ascend-FR-Q-933A',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8365,NULL,'Ascend-FR-LinkUp','Ascend-LinkUp-Default',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8366,NULL,'Ascend-FR-LinkUp','Ascend-LinkUp-AlwaysUp',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8367,NULL,'Ascend-Multicast-Client','Multicast-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8368,NULL,'Ascend-Multicast-Client','Multicast-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8369,NULL,'Ascend-User-Acct-Type','Ascend-User-Acct-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8370,NULL,'Ascend-User-Acct-Type','Ascend-User-Acct-User',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8371,NULL,'Ascend-User-Acct-Type','Ascend-User-Acct-User-Default',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8372,NULL,'Ascend-User-Acct-Base','Base-10',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8373,NULL,'Ascend-User-Acct-Base','Base-16',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8374,NULL,'Ascend-DHCP-Reply','DHCP-Reply-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8375,NULL,'Ascend-DHCP-Reply','DHCP-Reply-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8376,NULL,'Ascend-Client-Assign-DNS','DNS-Assign-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8377,NULL,'Ascend-Client-Assign-DNS','DNS-Assign-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8378,NULL,'Ascend-Event-Type','Ascend-ColdStart',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8379,NULL,'Ascend-Event-Type','Ascend-Session-Event',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8380,NULL,'Ascend-BACP-Enable','BACP-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8381,NULL,'Ascend-BACP-Enable','BACP-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8382,NULL,'Ascend-Dialout-Allowed','Dialout-Not-Allowed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8383,NULL,'Ascend-Dialout-Allowed','Dialout-Allowed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8384,NULL,'Ascend-Shared-Profile-Enable','Shared-Profile-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8385,NULL,'Ascend-Shared-Profile-Enable','Shared-Profile-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8386,NULL,'Ascend-Temporary-Rtes','Temp-Rtes-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8387,NULL,'Ascend-Temporary-Rtes','Temp-Rtes-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8388,NULL,'Ascend-Disconnect-Cause','No-Reason',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8389,NULL,'Ascend-Disconnect-Cause','Not-Applicable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8390,NULL,'Ascend-Disconnect-Cause','Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8391,NULL,'Ascend-Disconnect-Cause','Call-Disconnected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8392,NULL,'Ascend-Disconnect-Cause','CLID-Authentication-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8393,NULL,'Ascend-Disconnect-Cause','CLID-RADIUS-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8394,NULL,'Ascend-Disconnect-Cause','Modem-No-DCD',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8395,NULL,'Ascend-Disconnect-Cause','DCD-Detected-Then-Inactive',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8396,NULL,'Ascend-Disconnect-Cause','Modem-Invalid-Result-Codes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8397,NULL,'Ascend-Disconnect-Cause','TermSrv-User-Quit',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8398,NULL,'Ascend-Disconnect-Cause','TermSrv-Idle-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8399,NULL,'Ascend-Disconnect-Cause','TermSrv-Exit-Telnet',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8400,NULL,'Ascend-Disconnect-Cause','TermSrv-No-IPaddr',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8401,NULL,'Ascend-Disconnect-Cause','TermSrv-Exit-Raw-TCP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8402,NULL,'Ascend-Disconnect-Cause','TermSrv-Exit-Login-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8403,NULL,'Ascend-Disconnect-Cause','TermSrv-Exit-Raw-TCP-Disabled',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8404,NULL,'Ascend-Disconnect-Cause','TermSrv-CTRL-C-In-Login',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8405,NULL,'Ascend-Disconnect-Cause','TermSrv-Destroyed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8406,NULL,'Ascend-Disconnect-Cause','TermSrv-User-Closed-VCon',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8407,NULL,'Ascend-Disconnect-Cause','TermSrv-VCon-Destroyed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8408,NULL,'Ascend-Disconnect-Cause','TermSrv-Exit-Rlogin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8409,NULL,'Ascend-Disconnect-Cause','TermSrv-Bad-Rlogin-Option',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8410,NULL,'Ascend-Disconnect-Cause','TermSrv-Not-Enough-Resources',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8411,NULL,'Ascend-Disconnect-Cause','MPP-No-NULL-Msg-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8412,NULL,'Ascend-Disconnect-Cause','PPP-LCP-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8413,NULL,'Ascend-Disconnect-Cause','PPP-LCP-Negotion-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8414,NULL,'Ascend-Disconnect-Cause','PPP-PAP-Auth-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8415,NULL,'Ascend-Disconnect-Cause','PPP-CHAP-Auth-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8416,NULL,'Ascend-Disconnect-Cause','PPP-Rmt-Auth-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8417,NULL,'Ascend-Disconnect-Cause','PPP-Rcv-Terminate-Req',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8418,NULL,'Ascend-Disconnect-Cause','PPP-Rcv-Close-Event',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8419,NULL,'Ascend-Disconnect-Cause','PPP-No-NCPs-Open',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8420,NULL,'Ascend-Disconnect-Cause','PPP-MP-Bundle-Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8421,NULL,'Ascend-Disconnect-Cause','PPP-LCP-Close-MP-Add-Fail',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8422,NULL,'Ascend-Disconnect-Cause','Session-Table-Full',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8423,NULL,'Ascend-Disconnect-Cause','Out-Of-Resources',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8424,NULL,'Ascend-Disconnect-Cause','Invalid-IP-Address',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8425,NULL,'Ascend-Disconnect-Cause','Hostname-Resolution-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8426,NULL,'Ascend-Disconnect-Cause','Bad-Or-Missing-Port-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8427,NULL,'Ascend-Disconnect-Cause','Host-Reset',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8428,NULL,'Ascend-Disconnect-Cause','Connection-Refused',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8429,NULL,'Ascend-Disconnect-Cause','Connection-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8430,NULL,'Ascend-Disconnect-Cause','Connection-Closed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8431,NULL,'Ascend-Disconnect-Cause','Network-Unreachable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8432,NULL,'Ascend-Disconnect-Cause','Host-Unreachable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8433,NULL,'Ascend-Disconnect-Cause','Network-Unreachable-Admin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8434,NULL,'Ascend-Disconnect-Cause','Host-Unreachable-Admin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8435,NULL,'Ascend-Disconnect-Cause','Port-Unreachable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8436,NULL,'Ascend-Disconnect-Cause','Session-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8437,NULL,'Ascend-Disconnect-Cause','Invalid-Incoming-User',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8438,NULL,'Ascend-Disconnect-Cause','Disconnect-Due-To-Callback',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8439,NULL,'Ascend-Disconnect-Cause','Proto-Disabled-Or-Unsupported',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8440,NULL,'Ascend-Disconnect-Cause','Disconnect-Req-By-RADIUS',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8441,NULL,'Ascend-Disconnect-Cause','Disconnect-Req-By-Local-Admin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8442,NULL,'Ascend-Disconnect-Cause','V110-Timeout-Sync-Retry-Exceed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8443,NULL,'Ascend-Disconnect-Cause','PPP-Auth-Timeout-Exceeded',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8444,NULL,'Ascend-Disconnect-Cause','User-Executed-Do-Hangup',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8445,NULL,'Ascend-Disconnect-Cause','Remote-End-Hung-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8446,NULL,'Ascend-Disconnect-Cause','Resource-Has-Been-Quiesced',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8447,NULL,'Ascend-Disconnect-Cause','Max-Call-Duration-Reached',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8448,NULL,'Ascend-Connect-Progress','No-Progress',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8449,NULL,'Ascend-Connect-Progress','Call-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8450,NULL,'Ascend-Connect-Progress','Modem-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8451,NULL,'Ascend-Connect-Progress','Modem-Awaiting-DCD',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8452,NULL,'Ascend-Connect-Progress','Modem-Awaiting-Codes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8453,NULL,'Ascend-Connect-Progress','TermSrv-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8454,NULL,'Ascend-Connect-Progress','TermSrv-Raw-TCP-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8455,NULL,'Ascend-Connect-Progress','TermSrv-Telnet-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8456,NULL,'Ascend-Connect-Progress','TermSrv-Raw-TCP-Connected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8457,NULL,'Ascend-Connect-Progress','TermSrv-Telnet-Connected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8458,NULL,'Ascend-Connect-Progress','TermSrv-Rlogin-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8459,NULL,'Ascend-Connect-Progress','TermSrv-Rlogin-Connected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8460,NULL,'Ascend-Connect-Progress','Modem-Outdial-Call-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8461,NULL,'Ascend-Connect-Progress','LAN-Session-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8462,NULL,'Ascend-Connect-Progress','LCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8463,NULL,'Ascend-Connect-Progress','CCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8464,NULL,'Ascend-Connect-Progress','IPNCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8465,NULL,'Ascend-Connect-Progress','BNCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8466,NULL,'Ascend-Connect-Progress','LCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8467,NULL,'Ascend-Connect-Progress','CCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8468,NULL,'Ascend-Connect-Progress','IPNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8469,NULL,'Ascend-Connect-Progress','BNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8470,NULL,'Ascend-Connect-Progress','LCP-State-Initial',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8471,NULL,'Ascend-Connect-Progress','LCP-State-Starting',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8472,NULL,'Ascend-Connect-Progress','LCP-State-Closed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8473,NULL,'Ascend-Connect-Progress','LCP-State-Stopped',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8474,NULL,'Ascend-Connect-Progress','LCP-State-Closing',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8475,NULL,'Ascend-Connect-Progress','LCP-State-Stopping',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8476,NULL,'Ascend-Connect-Progress','LCP-State-Request-Sent',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8477,NULL,'Ascend-Connect-Progress','LCP-State-Ack-Received',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8478,NULL,'Ascend-Connect-Progress','LCP-State-Ack-Sent',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8479,NULL,'Ascend-Connect-Progress','IPXNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8480,NULL,'Ascend-Connect-Progress','ATNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8481,NULL,'Ascend-Connect-Progress','BACP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8482,NULL,'Ascend-Connect-Progress','BACP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8483,NULL,'Ascend-Connect-Progress','V110-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8484,NULL,'Ascend-Connect-Progress','V110-State-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8485,NULL,'Ascend-Connect-Progress','V110-State-Carrier',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8486,NULL,'Ascend-Connect-Progress','V110-State-Reset',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8487,NULL,'Ascend-Connect-Progress','V110-State-Closed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8488,NULL,'Ascend-ATM-Direct','ATM-Direct-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8489,NULL,'Ascend-ATM-Direct','ATM-Direct-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8490,NULL,'Ascend-ATM-Fault-Management','VC-End-To-End-Loopback',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8491,NULL,'Ascend-ATM-Fault-Management','VC-No-Loopback',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8492,NULL,'Ascend-ATM-Fault-Management','VC-Segment-Loopback',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8493,NULL,'Ascend-Appletalk-Peer-Mode','Appletalk-Peer-Dialin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8494,NULL,'Ascend-Appletalk-Peer-Mode','Appletalk-Peer-Router',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8495,NULL,'Ascend-Auth-Type','Auth-Any',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8496,NULL,'Ascend-Auth-Type','Auth-CHAP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8497,NULL,'Ascend-Auth-Type','Auth-Default',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8498,NULL,'Ascend-Auth-Type','Auth-MS-CHAP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8499,NULL,'Ascend-Auth-Type','Auth-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8500,NULL,'Ascend-Auth-Type','Auth-PAP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8501,NULL,'Ascend-BIR-Enable','BIR-Enable-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8502,NULL,'Ascend-BIR-Enable','BIR-Enable-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8503,NULL,'Ascend-BIR-Proxy','BIR-Proxy-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8504,NULL,'Ascend-BIR-Proxy','BIR-Proxy-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8505,NULL,'Ascend-Bi-Directional-Auth','Bi-Directional-Auth-Allowed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8506,NULL,'Ascend-Bi-Directional-Auth','Bi-Directional-Auth-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8507,NULL,'Ascend-Bi-Directional-Auth','Bi-Directional-Auth-Required',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8508,NULL,'Ascend-Bridge-Non-PPPoE','Bridge-Non-PPPoE-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8509,NULL,'Ascend-Bridge-Non-PPPoE','Bridge-Non-PPPoE-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8510,NULL,'Ascend-Cache-Refresh','Refresh-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8511,NULL,'Ascend-Cache-Refresh','Refresh-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8512,NULL,'Ascend-Call-Direction','Ascend-Call-Direction-Incoming',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8513,NULL,'Ascend-Call-Direction','Ascend-Call-Direction-Outgoing',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8514,NULL,'Ascend-Calling-Id-Number-Plan','Data',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8515,NULL,'Ascend-Calling-Id-Number-Plan','ISDN-Telephony',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8516,NULL,'Ascend-Calling-Id-Number-Plan','National',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8517,NULL,'Ascend-Calling-Id-Number-Plan','Private',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8518,NULL,'Ascend-Calling-Id-Number-Plan','Telex',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8519,NULL,'Ascend-Calling-Id-Number-Plan','Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8520,NULL,'Ascend-Calling-Id-Presentatn','Allowed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8521,NULL,'Ascend-Calling-Id-Presentatn','Number-Not-Available',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8522,NULL,'Ascend-Calling-Id-Presentatn','Restricted',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8523,NULL,'Ascend-Calling-Id-Screening','Network-Provided',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8524,NULL,'Ascend-Calling-Id-Screening','User-Not-Screened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8525,NULL,'Ascend-Calling-Id-Screening','User-Provided-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8526,NULL,'Ascend-Calling-Id-Screening','User-Provided-Passed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8527,NULL,'Ascend-Calling-Id-Type-Of-Num','Abbreviated-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8528,NULL,'Ascend-Calling-Id-Type-Of-Num','International-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8529,NULL,'Ascend-Calling-Id-Type-Of-Num','National-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8530,NULL,'Ascend-Calling-Id-Type-Of-Num','Network-Specific',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8531,NULL,'Ascend-Calling-Id-Type-Of-Num','Subscriber-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8532,NULL,'Ascend-Calling-Id-Type-Of-Num','Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8533,NULL,'Ascend-Ckt-Type','Ascend-PVC',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8534,NULL,'Ascend-Ckt-Type','Ascend-SVC',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8535,NULL,'Ascend-Client-Assign-WINS','WINS-Assign-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8536,NULL,'Ascend-Client-Assign-WINS','WINS-Assign-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8537,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-1280000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8538,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-1600000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8539,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-1920000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8540,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-2240000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8541,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-2560000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8542,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-2688000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8543,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-3200000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8544,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-4480000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8545,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-5120000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8546,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-6272000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8547,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-640000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8548,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-7168000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8549,NULL,'Ascend-Dsl-Downstream-Limit','adslcap-dn-960000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8550,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-128000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8551,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-1280000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8552,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-1600000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8553,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-1920000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8554,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-2240000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8555,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-256000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8556,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-2560000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8557,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-2688000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8558,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-3200000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8559,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-384000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8560,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-4480000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8561,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-512000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8562,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-5120000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8563,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-6272000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8564,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-640000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8565,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-7168000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8566,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-768000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8567,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-8000000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8568,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-8960000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8569,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-9504000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8570,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-960000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8571,NULL,'Ascend-Dsl-Downstream-Limit','adsldmt-dn-auto',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8572,NULL,'Ascend-Dsl-Rate-Mode','Rate-Mode-AutoBaud',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8573,NULL,'Ascend-Dsl-Rate-Mode','Rate-Mode-Single',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8574,NULL,'Ascend-Dsl-Rate-Type','Rate-Type-AdslCap',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8575,NULL,'Ascend-Dsl-Rate-Type','Rate-Type-AdslDmt',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8576,NULL,'Ascend-Dsl-Rate-Type','Rate-Type-AdslDmtCell',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8577,NULL,'Ascend-Dsl-Rate-Type','Rate-Type-Disabled',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8578,NULL,'Ascend-Dsl-Rate-Type','Rate-Type-Sdsl',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8579,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-896000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8580,NULL,'Ascend-Dsl-Upstream-Limit','adslcap-up-1088000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8581,NULL,'Ascend-Dsl-Upstream-Limit','adslcap-up-272000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8582,NULL,'Ascend-Dsl-Upstream-Limit','adslcap-up-408000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8583,NULL,'Ascend-Dsl-Upstream-Limit','adslcap-up-544000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8584,NULL,'Ascend-Dsl-Upstream-Limit','adslcap-up-680000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8585,NULL,'Ascend-Dsl-Upstream-Limit','adslcap-up-816000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8586,NULL,'Ascend-Dsl-Upstream-Limit','adslcap-up-952000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8587,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-1088000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8588,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-128000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8589,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-256000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8590,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-384000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8591,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-512000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8592,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-640000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8593,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-768000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8594,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-800000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8595,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-928000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8596,NULL,'Ascend-Dsl-Upstream-Limit','adsldmt-up-auto',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8597,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-1168000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8598,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-144000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8599,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-1552000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8600,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-2320000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8601,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-272000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8602,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-400000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8603,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-528000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8604,NULL,'Ascend-Dsl-Upstream-Limit','sdsl-784000',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8605,NULL,'Ascend-FR-Link-Status-DLCI','Ascend-FR-LMI-Dlci-0',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8606,NULL,'Ascend-FR-Link-Status-DLCI','Ascend-FR-LMI-Dlci-1023',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8607,NULL,'Ascend-Filter-Required','Required-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8608,NULL,'Ascend-Filter-Required','Required-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8609,NULL,'Ascend-IP-Pool-Chaining','IP-Pool-Chaining-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8610,NULL,'Ascend-IP-Pool-Chaining','IP-Pool-Chaining-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8611,NULL,'Ascend-IP-TOS','IP-TOS-Cost',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8612,NULL,'Ascend-IP-TOS','IP-TOS-Disabled',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8613,NULL,'Ascend-IP-TOS','IP-TOS-Latency',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8614,NULL,'Ascend-IP-TOS','IP-TOS-Normal',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8615,NULL,'Ascend-IP-TOS','IP-TOS-Reliability',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8616,NULL,'Ascend-IP-TOS','IP-TOS-Throughput',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8617,NULL,'Ascend-IP-TOS-Apply-To','IP-TOS-Apply-To-Both',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8618,NULL,'Ascend-IP-TOS-Apply-To','IP-TOS-Apply-To-Incoming',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8619,NULL,'Ascend-IP-TOS-Apply-To','IP-TOS-Apply-To-Outgoing',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8620,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-Five',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8621,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-Four',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8622,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-Normal',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8623,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-One',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8624,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-Seven',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8625,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-Six',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8626,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-Three',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8627,NULL,'Ascend-IP-TOS-Precedence','IP-TOS-Precedence-Pri-Two',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8628,NULL,'Ascend-IPX-Header-Compression','IPX-Header-Compression-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8629,NULL,'Ascend-IPX-Header-Compression','IPX-Header-Compression-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8630,NULL,'Ascend-NAS-Port-Format','1_2_2',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8631,NULL,'Ascend-NAS-Port-Format','2_4_5_5',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8632,NULL,'Ascend-NAS-Port-Format','2_4_6_4',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8633,NULL,'Ascend-NAS-Port-Format','Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8634,NULL,'Ascend-Numbering-Plan-ID','ISDN-Numbering-Plan',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8635,NULL,'Ascend-Numbering-Plan-ID','Private-Numbering-Plan',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8636,NULL,'Ascend-Numbering-Plan-ID','Unknown-Numbering-Plan',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8637,NULL,'Ascend-PPPoE-Enable','PPPoE-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8638,NULL,'Ascend-PPPoE-Enable','PPPoE-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8639,NULL,'Ascend-Port-Redir-Protocol','Ascend-Proto-TCP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8640,NULL,'Ascend-Port-Redir-Protocol','Ascend-Proto-UDP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8641,NULL,'Ascend-Private-Route-Required','Required-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8642,NULL,'Ascend-Private-Route-Required','Required-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8643,NULL,'Ascend-Route-Appletalk','Route-Appletalk-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8644,NULL,'Ascend-Route-Appletalk','Route-Appletalk-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8645,NULL,'Ascend-SVC-Enabled','Ascend-SVC-Enabled-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8646,NULL,'Ascend-SVC-Enabled','Ascend-SVC-Enabled-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8647,NULL,'Ascend-Service-Type','Ascend-Service-Type-ATM',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8648,NULL,'Ascend-Service-Type','Ascend-Service-Type-Combinet',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8649,NULL,'Ascend-Service-Type','Ascend-Service-Type-EuRaw',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8650,NULL,'Ascend-Service-Type','Ascend-Service-Type-EuUi',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8651,NULL,'Ascend-Service-Type','Ascend-Service-Type-FR',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8652,NULL,'Ascend-Service-Type','Ascend-Service-Type-HdlcNrm',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8653,NULL,'Ascend-Service-Type','Ascend-Service-Type-IpFax',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8654,NULL,'Ascend-Service-Type','Ascend-Service-Type-MP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8655,NULL,'Ascend-Service-Type','Ascend-Service-Type-MPP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8656,NULL,'Ascend-Service-Type','Ascend-Service-Type-NetToNet',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8657,NULL,'Ascend-Service-Type','Ascend-Service-Type-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8658,NULL,'Ascend-Service-Type','Ascend-Service-Type-NotUsed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8659,NULL,'Ascend-Service-Type','Ascend-Service-Type-Other',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8660,NULL,'Ascend-Service-Type','Ascend-Service-Type-PPP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8661,NULL,'Ascend-Service-Type','Ascend-Service-Type-PseuTunPPP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8662,NULL,'Ascend-Service-Type','Ascend-Service-Type-RawTcp',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8663,NULL,'Ascend-Service-Type','Ascend-Service-Type-Slip',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8664,NULL,'Ascend-Service-Type','Ascend-Service-Type-Telnet',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8665,NULL,'Ascend-Service-Type','Ascend-Service-Type-TelnetBin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8666,NULL,'Ascend-Service-Type','Ascend-Service-Type-TermServer',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8667,NULL,'Ascend-Service-Type','Ascend-Service-Type-VirtualConn',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8668,NULL,'Ascend-Service-Type','Ascend-Service-Type-Visa2',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8669,NULL,'Ascend-Service-Type','Ascend-Service-Type-VoIp',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8670,NULL,'Ascend-Service-Type','Ascend-Service-Type-X25',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8671,NULL,'Ascend-Service-Type','Ascend-Service-Type-X25DChan',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8672,NULL,'Ascend-Session-Type','Ascend-Session-G711-Alaw',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8673,NULL,'Ascend-Session-Type','Ascend-Session-G711-Ulaw',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8674,NULL,'Ascend-Session-Type','Ascend-Session-G723',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8675,NULL,'Ascend-Session-Type','Ascend-Session-G723-64KPS',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8676,NULL,'Ascend-Session-Type','Ascend-Session-G728',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8677,NULL,'Ascend-Session-Type','Ascend-Session-G729',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8678,NULL,'Ascend-Session-Type','Ascend-Session-RT24',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8679,NULL,'Ascend-Session-Type','Ascend-Session-Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8680,NULL,'Ascend-Session-Type','Ascend-Session-Unused',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8681,NULL,'Ascend-Tunneling-Protocol','ATMP-Tunnel',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8682,NULL,'Ascend-Tunneling-Protocol','VTP-Tunnel',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8683,NULL,'Ascend-X25-Pad-X3-Profile','CC_SSP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8684,NULL,'Ascend-X25-Pad-X3-Profile','CC_TSP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8685,NULL,'Ascend-X25-Pad-X3-Profile','CRT',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8686,NULL,'Ascend-X25-Pad-X3-Profile','CUSTOM',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8687,NULL,'Ascend-X25-Pad-X3-Profile','DEFAULT',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8688,NULL,'Ascend-X25-Pad-X3-Profile','HARDCOPY',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8689,NULL,'Ascend-X25-Pad-X3-Profile','HDX',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8690,NULL,'Ascend-X25-Pad-X3-Profile','INFONET',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8691,NULL,'Ascend-X25-Pad-X3-Profile','NULL',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8692,NULL,'Ascend-X25-Pad-X3-Profile','POS',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8693,NULL,'Ascend-X25-Pad-X3-Profile','SCEN',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8694,NULL,'Ascend-X25-Pad-X3-Profile','SHARK',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8695,NULL,'Ascend-X25-Reverse-Charging','Reverse-Charging-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8696,NULL,'Ascend-X25-Reverse-Charging','Reverse-Charging-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8697,'string','X-Ascend-FCP-Parameter',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8698,'integer','X-Ascend-Modem-PortNo',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8699,'integer','X-Ascend-Modem-SlotNo',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8700,'integer','X-Ascend-Modem-ShelfNo',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8701,'integer','X-Ascend-Call-Attempt-Limit',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8702,'integer','X-Ascend-Call-Block-Duration',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8703,'integer','X-Ascend-Maximum-Call-Duration',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8704,'integer','X-Ascend-Temporary-Rtes',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8705,'integer','X-Ascend-Tunneling-Protocol',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8706,'integer','X-Ascend-Shared-Profile-Enable',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8707,'string','X-Ascend-Primary-Home-Agent',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8708,'string','X-Ascend-Secondary-Home-Agent',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8709,'integer','X-Ascend-Dialout-Allowed',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8710,'ipaddr','X-Ascend-Client-Gateway',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8711,'integer','X-Ascend-BACP-Enable',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8712,'integer','X-Ascend-DHCP-Maximum-Leases',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8713,'ipaddr','X-Ascend-Client-Primary-DNS',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8714,'ipaddr','X-Ascend-Client-Secondary-DNS',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8715,'integer','X-Ascend-Client-Assign-DNS',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8716,'integer','X-Ascend-User-Acct-Type',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8717,'ipaddr','X-Ascend-User-Acct-Host',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8718,'integer','X-Ascend-User-Acct-Port',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8719,'string','X-Ascend-User-Acct-Key',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8720,'integer','X-Ascend-User-Acct-Base',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8721,'integer','X-Ascend-User-Acct-Time',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8722,'ipaddr','X-Ascend-Assign-IP-Client',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8723,'ipaddr','X-Ascend-Assign-IP-Server',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8724,'string','X-Ascend-Assign-IP-Global-Pool',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8725,'integer','X-Ascend-DHCP-Reply',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8726,'integer','X-Ascend-DHCP-Pool-Number',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8727,'integer','X-Ascend-Expect-Callback',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8728,'integer','X-Ascend-Event-Type',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8729,'string','X-Ascend-Session-Svr-Key',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8730,'integer','X-Ascend-Multicast-Rate-Limit',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8731,'ipaddr','X-Ascend-IF-Netmask',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8732,'ipaddr','X-Ascend-Remote-Addr',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8733,'integer','X-Ascend-Multicast-Client',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8734,'string','X-Ascend-FR-Circuit-Name',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8735,'integer','X-Ascend-FR-LinkUp',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8736,'integer','X-Ascend-FR-Nailed-Grp',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8737,'integer','X-Ascend-FR-Type',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8738,'integer','X-Ascend-FR-Link-Mgt',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8739,'integer','X-Ascend-FR-N391',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8740,'integer','X-Ascend-FR-DCE-N392',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8741,'integer','X-Ascend-FR-DTE-N392',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8742,'integer','X-Ascend-FR-DCE-N393',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8743,'integer','X-Ascend-FR-DTE-N393',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8744,'integer','X-Ascend-FR-T391',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8745,'integer','X-Ascend-FR-T392',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8746,'string','X-Ascend-Bridge-Address',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8747,'integer','X-Ascend-TS-Idle-Limit',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8748,'integer','X-Ascend-TS-Idle-Mode',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8749,'integer','X-Ascend-DBA-Monitor',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8750,'integer','X-Ascend-Base-Channel-Count',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8751,'integer','X-Ascend-Minimum-Channels',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8752,'string','X-Ascend-IPX-Route',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8753,'integer','X-Ascend-FT1-Caller',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8754,'string','X-Ascend-Backup',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8755,'integer','X-Ascend-Call-Type',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8756,'string','X-Ascend-Group',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8757,'integer','X-Ascend-FR-DLCI',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8758,'string','X-Ascend-FR-Profile-Name',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8759,'string','X-Ascend-Ara-PW',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8760,'string','X-Ascend-IPX-Node-Addr',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8761,'ipaddr','X-Ascend-Home-Agent-IP-Addr',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8762,'string','X-Ascend-Home-Agent-Password',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8763,'string','X-Ascend-Home-Network-Name',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8764,'integer','X-Ascend-Home-Agent-UDP-Port',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8765,'integer','X-Ascend-Multilink-ID',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8766,'integer','X-Ascend-Num-In-Multilink',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8767,'ipaddr','X-Ascend-First-Dest',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8768,'integer','X-Ascend-Pre-Input-Octets',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8769,'integer','X-Ascend-Pre-Output-Octets',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8770,'integer','X-Ascend-Pre-Input-Packets',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8771,'integer','X-Ascend-Pre-Output-Packets',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8772,'integer','X-Ascend-Maximum-Time',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8773,'integer','X-Ascend-Disconnect-Cause',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8774,'integer','X-Ascend-Connect-Progress',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8775,'integer','X-Ascend-Data-Rate',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8776,'integer','X-Ascend-PreSession-Time',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8777,'integer','X-Ascend-Token-Idle',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8778,'integer','X-Ascend-Token-Immediate',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8779,'integer','X-Ascend-Require-Auth',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8780,'string','X-Ascend-Number-Sessions',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8781,'string','X-Ascend-Authen-Alias',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8782,'integer','X-Ascend-Token-Expiry',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8783,'string','X-Ascend-Menu-Selector',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8784,'string','X-Ascend-Menu-Item',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8785,'integer','X-Ascend-PW-Warntime',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8786,'integer','X-Ascend-PW-Lifetime',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8787,'ipaddr','X-Ascend-IP-Direct',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8788,'integer','X-Ascend-PPP-VJ-Slot-Comp',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8789,'integer','X-Ascend-PPP-VJ-1172',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8790,'integer','X-Ascend-PPP-Async-Map',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8791,'string','X-Ascend-Third-Prompt',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8792,'string','X-Ascend-Send-Secret',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8793,'string','X-Ascend-Receive-Secret',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8794,'integer','X-Ascend-IPX-Peer-Mode',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8795,'string','X-Ascend-IP-Pool-Definition',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8796,'integer','X-Ascend-Assign-IP-Pool',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8797,'integer','X-Ascend-FR-Direct',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8798,'string','X-Ascend-FR-Direct-Profile',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8799,'integer','X-Ascend-FR-Direct-DLCI',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8800,'integer','X-Ascend-Handle-IPX',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8801,'integer','X-Ascend-Netware-timeout',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8802,'integer','X-Ascend-IPX-Alias',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8803,'integer','X-Ascend-Metric',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8804,'integer','X-Ascend-PRI-Number-Type',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8805,'string','X-Ascend-Dial-Number',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8806,'integer','X-Ascend-Route-IP',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8807,'integer','X-Ascend-Route-IPX',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8808,'integer','X-Ascend-Bridge',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8809,'integer','X-Ascend-Send-Auth',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8810,'string','X-Ascend-Send-Passwd',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8811,'integer','X-Ascend-Link-Compression',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8812,'integer','X-Ascend-Target-Util',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8813,'integer','X-Ascend-Maximum-Channels',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8814,'integer','X-Ascend-Inc-Channel-Count',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8815,'integer','X-Ascend-Dec-Channel-Count',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8816,'integer','X-Ascend-Seconds-Of-History',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8817,'integer','X-Ascend-History-Weigh-Type',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8818,'integer','X-Ascend-Add-Seconds',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8819,'integer','X-Ascend-Remove-Seconds',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8820,'abinary','X-Ascend-Data-Filter',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8821,'abinary','X-Ascend-Call-Filter',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8822,'integer','X-Ascend-Idle-Limit',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8823,'integer','X-Ascend-Preempt-Limit',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8824,'integer','X-Ascend-Callback',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8825,'integer','X-Ascend-Data-Svc',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8826,'integer','X-Ascend-Force-56',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8827,'string','X-Ascend-Billing-Number',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8828,'integer','X-Ascend-Call-By-Call',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8829,'string','X-Ascend-Transit-Number',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8830,'string','X-Ascend-Host-Info',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8831,'ipaddr','X-Ascend-PPP-Address',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8832,'integer','X-Ascend-MPP-Idle-Percent',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8833,'integer','X-Ascend-Xmit-Rate',NULL,NULL,'Ascend',NULL,NULL,NULL,NULL),
(8834,NULL,'X-Ascend-Temporary-Rtes','Temp-Rtes-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8835,NULL,'X-Ascend-Temporary-Rtes','Temp-Rtes-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8836,NULL,'X-Ascend-Tunneling-Protocol','ATMP-Tunnel',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8837,NULL,'X-Ascend-Tunneling-Protocol','VTP-Tunnel',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8838,NULL,'X-Ascend-Shared-Profile-Enable','Shared-Profile-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8839,NULL,'X-Ascend-Shared-Profile-Enable','Shared-Profile-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8840,NULL,'X-Ascend-Dialout-Allowed','Dialout-Not-Allowed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8841,NULL,'X-Ascend-Dialout-Allowed','Dialout-Allowed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8842,NULL,'X-Ascend-BACP-Enable','BACP-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8843,NULL,'X-Ascend-BACP-Enable','BACP-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8844,NULL,'X-Ascend-Client-Assign-DNS','DNS-Assign-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8845,NULL,'X-Ascend-Client-Assign-DNS','DNS-Assign-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8846,NULL,'X-Ascend-User-Acct-Type','Ascend-User-Acct-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8847,NULL,'X-Ascend-User-Acct-Type','Ascend-User-Acct-User',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8848,NULL,'X-Ascend-User-Acct-Type','Ascend-User-Acct-User-Default',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8849,NULL,'X-Ascend-User-Acct-Base','Base-10',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8850,NULL,'X-Ascend-User-Acct-Base','Base-16',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8851,NULL,'X-Ascend-DHCP-Reply','DHCP-Reply-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8852,NULL,'X-Ascend-DHCP-Reply','DHCP-Reply-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8853,NULL,'X-Ascend-Expect-Callback','Expect-Callback-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8854,NULL,'X-Ascend-Expect-Callback','Expect-Callback-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8855,NULL,'X-Ascend-Event-Type','Ascend-ColdStart',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8856,NULL,'X-Ascend-Event-Type','Ascend-Session-Event',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8857,NULL,'X-Ascend-Multicast-Client','Multicast-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8858,NULL,'X-Ascend-Multicast-Client','Multicast-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8859,NULL,'X-Ascend-FR-LinkUp','Ascend-LinkUp-Default',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8860,NULL,'X-Ascend-FR-LinkUp','Ascend-LinkUp-AlwaysUp',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8861,NULL,'X-Ascend-FR-Type','Ascend-FR-DTE',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8862,NULL,'X-Ascend-FR-Type','Ascend-FR-DCE',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8863,NULL,'X-Ascend-FR-Type','Ascend-FR-NNI',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8864,NULL,'X-Ascend-FR-Link-Mgt','Ascend-FR-No-Link-Mgt',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8865,NULL,'X-Ascend-FR-Link-Mgt','Ascend-FR-T1-617D',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8866,NULL,'X-Ascend-FR-Link-Mgt','Ascend-FR-Q-933A',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8867,NULL,'X-Ascend-TS-Idle-Mode','TS-Idle-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8868,NULL,'X-Ascend-TS-Idle-Mode','TS-Idle-Input',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8869,NULL,'X-Ascend-TS-Idle-Mode','TS-Idle-Input-Output',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8870,NULL,'X-Ascend-DBA-Monitor','DBA-Transmit',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8871,NULL,'X-Ascend-DBA-Monitor','DBA-Transmit-Recv',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8872,NULL,'X-Ascend-DBA-Monitor','DBA-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8873,NULL,'X-Ascend-FT1-Caller','FT1-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8874,NULL,'X-Ascend-FT1-Caller','FT1-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8875,NULL,'X-Ascend-Call-Type','Switched',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8876,NULL,'X-Ascend-Call-Type','Nailed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8877,NULL,'X-Ascend-Call-Type','Nailed/Mpp',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8878,NULL,'X-Ascend-Call-Type','Perm/Switched',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8879,NULL,'X-Ascend-Call-Type','AO/DI',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8880,NULL,'X-Ascend-Call-Type','MegaMax',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8881,NULL,'X-Ascend-Disconnect-Cause','No-Reason',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8882,NULL,'X-Ascend-Disconnect-Cause','Not-Applicable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8883,NULL,'X-Ascend-Disconnect-Cause','Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8884,NULL,'X-Ascend-Disconnect-Cause','Call-Disconnected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8885,NULL,'X-Ascend-Disconnect-Cause','CLID-Authentication-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8886,NULL,'X-Ascend-Disconnect-Cause','CLID-RADIUS-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8887,NULL,'X-Ascend-Disconnect-Cause','Modem-No-DCD',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8888,NULL,'X-Ascend-Disconnect-Cause','DCD-Detected-Then-Inactive',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8889,NULL,'X-Ascend-Disconnect-Cause','Modem-Invalid-Result-Codes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8890,NULL,'X-Ascend-Disconnect-Cause','TermSrv-User-Quit',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8891,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Idle-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8892,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Exit-Telnet',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8893,NULL,'X-Ascend-Disconnect-Cause','TermSrv-No-IPaddr',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8894,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Exit-Raw-TCP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8895,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Exit-Login-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8896,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Exit-Raw-TCP-Disabled',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8897,NULL,'X-Ascend-Disconnect-Cause','TermSrv-CTRL-C-In-Login',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8898,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Destroyed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8899,NULL,'X-Ascend-Disconnect-Cause','TermSrv-User-Closed-VCon',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8900,NULL,'X-Ascend-Disconnect-Cause','TermSrv-VCon-Destroyed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8901,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Exit-Rlogin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8902,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Bad-Rlogin-Option',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8903,NULL,'X-Ascend-Disconnect-Cause','TermSrv-Not-Enough-Resources',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8904,NULL,'X-Ascend-Disconnect-Cause','MPP-No-NULL-Msg-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8905,NULL,'X-Ascend-Disconnect-Cause','PPP-LCP-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8906,NULL,'X-Ascend-Disconnect-Cause','PPP-LCP-Negotion-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8907,NULL,'X-Ascend-Disconnect-Cause','PPP-PAP-Auth-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8908,NULL,'X-Ascend-Disconnect-Cause','PPP-CHAP-Auth-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8909,NULL,'X-Ascend-Disconnect-Cause','PPP-Rmt-Auth-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8910,NULL,'X-Ascend-Disconnect-Cause','PPP-Rcv-Terminate-Req',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8911,NULL,'X-Ascend-Disconnect-Cause','PPP-Rcv-Close-Event',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8912,NULL,'X-Ascend-Disconnect-Cause','PPP-No-NCPs-Open',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8913,NULL,'X-Ascend-Disconnect-Cause','PPP-MP-Bundle-Unknown',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8914,NULL,'X-Ascend-Disconnect-Cause','PPP-LCP-Close-MP-Add-Fail',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8915,NULL,'X-Ascend-Disconnect-Cause','Session-Table-Full',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8916,NULL,'X-Ascend-Disconnect-Cause','Out-Of-Resources',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8917,NULL,'X-Ascend-Disconnect-Cause','Invalid-IP-Address',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8918,NULL,'X-Ascend-Disconnect-Cause','Hostname-Resolution-Failed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8919,NULL,'X-Ascend-Disconnect-Cause','Bad-Or-Missing-Port-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8920,NULL,'X-Ascend-Disconnect-Cause','Host-Reset',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8921,NULL,'X-Ascend-Disconnect-Cause','Connection-Refused',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8922,NULL,'X-Ascend-Disconnect-Cause','Connection-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8923,NULL,'X-Ascend-Disconnect-Cause','Connection-Closed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8924,NULL,'X-Ascend-Disconnect-Cause','Network-Unreachable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8925,NULL,'X-Ascend-Disconnect-Cause','Host-Unreachable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8926,NULL,'X-Ascend-Disconnect-Cause','Network-Unreachable-Admin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8927,NULL,'X-Ascend-Disconnect-Cause','Host-Unreachable-Admin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8928,NULL,'X-Ascend-Disconnect-Cause','Port-Unreachable',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8929,NULL,'X-Ascend-Disconnect-Cause','Session-Timeout',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8930,NULL,'X-Ascend-Disconnect-Cause','Invalid-Incoming-User',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8931,NULL,'X-Ascend-Disconnect-Cause','Disconnect-Due-To-Callback',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8932,NULL,'X-Ascend-Disconnect-Cause','Proto-Disabled-Or-Unsupported',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8933,NULL,'X-Ascend-Disconnect-Cause','Disconnect-Req-By-RADIUS',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8934,NULL,'X-Ascend-Disconnect-Cause','Disconnect-Req-By-Local-Admin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8935,NULL,'X-Ascend-Disconnect-Cause','V110-Timeout-Sync-Retry-Exceed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8936,NULL,'X-Ascend-Disconnect-Cause','PPP-Auth-Timeout-Exceeded',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8937,NULL,'X-Ascend-Disconnect-Cause','User-Executed-Do-Hangup',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8938,NULL,'X-Ascend-Disconnect-Cause','Remote-End-Hung-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8939,NULL,'X-Ascend-Disconnect-Cause','Resource-Has-Been-Quiesced',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8940,NULL,'X-Ascend-Disconnect-Cause','Max-Call-Duration-Reached',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8941,NULL,'X-Ascend-Connect-Progress','No-Progress',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8942,NULL,'X-Ascend-Connect-Progress','Call-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8943,NULL,'X-Ascend-Connect-Progress','Modem-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8944,NULL,'X-Ascend-Connect-Progress','Modem-Awaiting-DCD',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8945,NULL,'X-Ascend-Connect-Progress','Modem-Awaiting-Codes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8946,NULL,'X-Ascend-Connect-Progress','TermSrv-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8947,NULL,'X-Ascend-Connect-Progress','TermSrv-Raw-TCP-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8948,NULL,'X-Ascend-Connect-Progress','TermSrv-Telnet-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8949,NULL,'X-Ascend-Connect-Progress','TermSrv-Raw-TCP-Connected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8950,NULL,'X-Ascend-Connect-Progress','TermSrv-Telnet-Connected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8951,NULL,'X-Ascend-Connect-Progress','TermSrv-Rlogin-Started',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8952,NULL,'X-Ascend-Connect-Progress','TermSrv-Rlogin-Connected',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8953,NULL,'X-Ascend-Connect-Progress','Modem-Outdial-Call-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8954,NULL,'X-Ascend-Connect-Progress','LAN-Session-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8955,NULL,'X-Ascend-Connect-Progress','LCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8956,NULL,'X-Ascend-Connect-Progress','CCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8957,NULL,'X-Ascend-Connect-Progress','IPNCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8958,NULL,'X-Ascend-Connect-Progress','BNCP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8959,NULL,'X-Ascend-Connect-Progress','LCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8960,NULL,'X-Ascend-Connect-Progress','CCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8961,NULL,'X-Ascend-Connect-Progress','IPNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8962,NULL,'X-Ascend-Connect-Progress','BNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8963,NULL,'X-Ascend-Connect-Progress','LCP-State-Initial',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8964,NULL,'X-Ascend-Connect-Progress','LCP-State-Starting',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8965,NULL,'X-Ascend-Connect-Progress','LCP-State-Closed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8966,NULL,'X-Ascend-Connect-Progress','LCP-State-Stopped',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8967,NULL,'X-Ascend-Connect-Progress','LCP-State-Closing',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8968,NULL,'X-Ascend-Connect-Progress','LCP-State-Stopping',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8969,NULL,'X-Ascend-Connect-Progress','LCP-State-Request-Sent',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8970,NULL,'X-Ascend-Connect-Progress','LCP-State-Ack-Received',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8971,NULL,'X-Ascend-Connect-Progress','LCP-State-Ack-Sent',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8972,NULL,'X-Ascend-Connect-Progress','IPXNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8973,NULL,'X-Ascend-Connect-Progress','ATNCP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8974,NULL,'X-Ascend-Connect-Progress','BACP-Opening',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8975,NULL,'X-Ascend-Connect-Progress','BACP-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8976,NULL,'X-Ascend-Connect-Progress','V110-Up',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8977,NULL,'X-Ascend-Connect-Progress','V110-State-Opened',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8978,NULL,'X-Ascend-Connect-Progress','V110-State-Carrier',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8979,NULL,'X-Ascend-Connect-Progress','V110-State-Reset',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8980,NULL,'X-Ascend-Connect-Progress','V110-State-Closed',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8981,NULL,'X-Ascend-Token-Immediate','Tok-Imm-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8982,NULL,'X-Ascend-Token-Immediate','Tok-Imm-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8983,NULL,'X-Ascend-Require-Auth','Not-Require-Auth',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8984,NULL,'X-Ascend-Require-Auth','Require-Auth',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8985,NULL,'X-Ascend-PW-Warntime','Days-Of-Warning',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8986,NULL,'X-Ascend-PW-Lifetime','Lifetime-In-Days',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8987,NULL,'X-Ascend-PPP-VJ-Slot-Comp','VJ-Slot-Comp-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8988,NULL,'X-Ascend-PPP-VJ-1172','PPP-VJ-1172',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8989,NULL,'X-Ascend-IPX-Peer-Mode','IPX-Peer-Router',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8990,NULL,'X-Ascend-IPX-Peer-Mode','IPX-Peer-Dialin',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8991,NULL,'X-Ascend-FR-Direct','FR-Direct-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8992,NULL,'X-Ascend-FR-Direct','FR-Direct-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8993,NULL,'X-Ascend-Handle-IPX','Handle-IPX-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8994,NULL,'X-Ascend-Handle-IPX','Handle-IPX-Client',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8995,NULL,'X-Ascend-Handle-IPX','Handle-IPX-Server',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8996,NULL,'X-Ascend-PRI-Number-Type','Unknown-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8997,NULL,'X-Ascend-PRI-Number-Type','Intl-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8998,NULL,'X-Ascend-PRI-Number-Type','National-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(8999,NULL,'X-Ascend-PRI-Number-Type','Net-Specific-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9000,NULL,'X-Ascend-PRI-Number-Type','Local-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9001,NULL,'X-Ascend-PRI-Number-Type','Abbrev-Number',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9002,NULL,'X-Ascend-Route-IP','Route-IP-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9003,NULL,'X-Ascend-Route-IP','Route-IP-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9004,NULL,'X-Ascend-Route-IPX','Route-IPX-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9005,NULL,'X-Ascend-Route-IPX','Route-IPX-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9006,NULL,'X-Ascend-Route-IPX','Route-IPX-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9007,NULL,'X-Ascend-Route-IPX','Route-IPX-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9008,NULL,'X-Ascend-Bridge','Bridge-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9009,NULL,'X-Ascend-Bridge','Bridge-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9010,NULL,'X-Ascend-Send-Auth','Send-Auth-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9011,NULL,'X-Ascend-Send-Auth','Send-Auth-PAP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9012,NULL,'X-Ascend-Send-Auth','Send-Auth-CHAP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9013,NULL,'X-Ascend-Send-Auth','Send-Auth-MS-CHAP',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9014,NULL,'X-Ascend-Link-Compression','Link-Comp-None',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9015,NULL,'X-Ascend-Link-Compression','Link-Comp-Stac',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9016,NULL,'X-Ascend-Link-Compression','Link-Comp-Stac-Draft-9',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9017,NULL,'X-Ascend-Link-Compression','Link-Comp-MS-Stac',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9018,NULL,'X-Ascend-History-Weigh-Type','History-Constant',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9019,NULL,'X-Ascend-History-Weigh-Type','History-Linear',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9020,NULL,'X-Ascend-History-Weigh-Type','History-Quadratic',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9021,NULL,'X-Ascend-Callback','Callback-No',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9022,NULL,'X-Ascend-Callback','Callback-Yes',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9023,NULL,'X-Ascend-Data-Svc','Switched-Voice-Bearer',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9024,NULL,'X-Ascend-Data-Svc','Nailed-56KR',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9025,NULL,'X-Ascend-Data-Svc','Nailed-64K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9026,NULL,'X-Ascend-Data-Svc','Switched-64KR',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9027,NULL,'X-Ascend-Data-Svc','Switched-56K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9028,NULL,'X-Ascend-Data-Svc','Switched-384KR',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9029,NULL,'X-Ascend-Data-Svc','Switched-384K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9030,NULL,'X-Ascend-Data-Svc','Switched-1536K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9031,NULL,'X-Ascend-Data-Svc','Switched-1536KR',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9032,NULL,'X-Ascend-Data-Svc','Switched-128K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9033,NULL,'X-Ascend-Data-Svc','Switched-192K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9034,NULL,'X-Ascend-Data-Svc','Switched-256K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9035,NULL,'X-Ascend-Data-Svc','Switched-320K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9036,NULL,'X-Ascend-Data-Svc','Switched-384K-MR',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9037,NULL,'X-Ascend-Data-Svc','Switched-448K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9038,NULL,'X-Ascend-Data-Svc','Switched-512K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9039,NULL,'X-Ascend-Data-Svc','Switched-576K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9040,NULL,'X-Ascend-Data-Svc','Switched-640K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9041,NULL,'X-Ascend-Data-Svc','Switched-704K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9042,NULL,'X-Ascend-Data-Svc','Switched-768K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9043,NULL,'X-Ascend-Data-Svc','Switched-832K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9044,NULL,'X-Ascend-Data-Svc','Switched-896K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9045,NULL,'X-Ascend-Data-Svc','Switched-960K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9046,NULL,'X-Ascend-Data-Svc','Switched-1024K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9047,NULL,'X-Ascend-Data-Svc','Switched-1088K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9048,NULL,'X-Ascend-Data-Svc','Switched-1152K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9049,NULL,'X-Ascend-Data-Svc','Switched-1216K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9050,NULL,'X-Ascend-Data-Svc','Switched-1280K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9051,NULL,'X-Ascend-Data-Svc','Switched-1344K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9052,NULL,'X-Ascend-Data-Svc','Switched-1408K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9053,NULL,'X-Ascend-Data-Svc','Switched-1472K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9054,NULL,'X-Ascend-Data-Svc','Switched-1600K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9055,NULL,'X-Ascend-Data-Svc','Switched-1664K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9056,NULL,'X-Ascend-Data-Svc','Switched-1728K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9057,NULL,'X-Ascend-Data-Svc','Switched-1792K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9058,NULL,'X-Ascend-Data-Svc','Switched-1856K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9059,NULL,'X-Ascend-Data-Svc','Switched-1920K',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9060,NULL,'X-Ascend-Data-Svc','Switched-inherited',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9061,NULL,'X-Ascend-Data-Svc','Switched-restricted-bearer-x30',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9062,NULL,'X-Ascend-Data-Svc','Switched-clear-bearer-v110',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9063,NULL,'X-Ascend-Data-Svc','Switched-restricted-64-x30',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9064,NULL,'X-Ascend-Data-Svc','Switched-clear-56-v110',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9065,NULL,'X-Ascend-Data-Svc','Switched-modem',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9066,NULL,'X-Ascend-Data-Svc','Switched-atmodem',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9067,NULL,'X-Ascend-Data-Svc','Switched-V110-24-56',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9068,NULL,'X-Ascend-Data-Svc','Switched-V110-48-56',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9069,NULL,'X-Ascend-Data-Svc','Switched-V110-96-56',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9070,NULL,'X-Ascend-Data-Svc','Switched-V110-192-56',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9071,NULL,'X-Ascend-Data-Svc','Switched-V110-384-56',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9072,NULL,'X-Ascend-Data-Svc','Switched-V110-24-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9073,NULL,'X-Ascend-Data-Svc','Switched-V110-48-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9074,NULL,'X-Ascend-Data-Svc','Switched-V110-96-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9075,NULL,'X-Ascend-Data-Svc','Switched-V110-192-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9076,NULL,'X-Ascend-Data-Svc','Switched-V110-384-56R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9077,NULL,'X-Ascend-Data-Svc','Switched-V110-24-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9078,NULL,'X-Ascend-Data-Svc','Switched-V110-48-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9079,NULL,'X-Ascend-Data-Svc','Switched-V110-96-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9080,NULL,'X-Ascend-Data-Svc','Switched-V110-192-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9081,NULL,'X-Ascend-Data-Svc','Switched-V110-384-64',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9082,NULL,'X-Ascend-Data-Svc','Switched-V110-24-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9083,NULL,'X-Ascend-Data-Svc','Switched-V110-48-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9084,NULL,'X-Ascend-Data-Svc','Switched-V110-96-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9085,NULL,'X-Ascend-Data-Svc','Switched-V110-384-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9086,NULL,'X-Ascend-Data-Svc','Switched-V110-192-64R',NULL,'Ascend',NULL,NULL,NULL,NULL),
(9087,NULL,'X-Ascend-Data-Svc','Switched-Pots',NULL,'Ascend',NULL,NULL,NULL,NULL),
...
(9590,'byte','WiMAX-Device-Authentication-Indicator',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9591,'signed','WiMAX-GMT-Timezone-offset',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9592,'octets','WiMAX-AAA-Session-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
...
(9095,'integer','ChilliSpot-Max-Input-Octets',NULL,NULL,'ChilliSpot',':=','reply','','Maximum number of octets the user is allowed to transmit. After this limit has been reached the user will be disconnected. (Specified in bytes)		'),
(9096,'integer','ChilliSpot-Max-Output-Octets',NULL,NULL,'ChilliSpot',':=','reply',NULL,'Maximum number of octets the user is allowed to receive. After this limit has been reached the user will be disconnected. (Specified in bytes)'),
(9097,'integer','ChilliSpot-Max-Total-Octets',NULL,NULL,'ChilliSpot',':=','reply',NULL,'Maximum total octets the user is allowed to send or receive. After this limit has been reached the user will be disconnected. (Specified in bytes)'),
(9098,'integer','ChilliSpot-Bandwidth-Max-Up',NULL,NULL,'ChilliSpot',':=','reply',NULL,'WISPr vendor specific attributes for setting the maximum bandwidth rate in bits per second.'),
(9099,'integer','ChilliSpot-Bandwidth-Max-Down',NULL,NULL,'ChilliSpot',':=','reply',NULL,'WISPr vendor specific attributes for setting the maximum bandwidth rate in bits per second.'),
(9100,'string','ChilliSpot-Config',NULL,NULL,'ChilliSpot',':=','reply',NULL,'Configurations passed between chilli and back-end as name value pairs'),
(9101,'string','ChilliSpot-Lang',NULL,NULL,'ChilliSpot',':=','reply',NULL,'Language selected in user interface	'),
(9102,'string','ChilliSpot-Version',NULL,NULL,'ChilliSpot',':=','reply',NULL,'Version of Chilli sending this AccessRequest'),
(9103,'string','ChilliSpot-UAM-Allowed',NULL,NULL,'ChilliSpot',':=','reply',NULL,'\r\n	When received from the radius server in an RFC 2882 style configuration management message this attribute will override the uamallowed command line option.'),
(9104,'string','ChilliSpot-MAC-Allowed',NULL,NULL,'ChilliSpot',':=','reply',NULL,'When received from the radius server in an RFC 2882 style configuration management message this attribute will override the macallowed command line option.'),
(9105,'integer','ChilliSpot-Interval',NULL,NULL,'ChilliSpot',':=','reply',NULL,'When received from the radius server in an RFC 2882 style configuration management message this attribute will override the interval command line option.'),
...
(9378,'integer','WiMAX-Active-Time-Duration',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9377,'integer #s','WiMAX-Time-Interval-After',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9376,'integer #s','WiMAX-Tariff-Switch-Interval',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9375,'integer #1k','WiMAX-Volume-Used-After',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9374,'string','WiMAX-Prepaid-Quota-Identifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9373,'tlv','WiMAX-Prepaid-Tariff-Switching',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9372,'octets','WiMAX-Cost-Information-AVP',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9371,'byte','WiMAX-Check-Balance-Result',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9370,'byte','WiMAX-Requested-Action',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9369,'integer','WiMAX-Pool-Multiplier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9368,'integer','WiMAX-Pool-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9367,'byte','WiMAX-Termination-Action',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9366,'integer','WiMAX-Rating-Group-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9365,'string','WiMAX-Service-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9364,'combo-ip','WiMAX-Prepaid-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9363,'integer','WiMAX-Update-Reason',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9362,'integer','WiMAX-Resource-Threshold',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9361,'integer','WiMAX-Resource-Quota',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9360,'integer #s','WiMAX-Duration-Threshold',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9359,'integer #s','WiMAX-Duration-Quota',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9358,'integer #kb','WiMAX-Volume-Threshold',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9357,'integer #kb','WiMAX-Volume-Quota',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9356,'octets','WiMAX-PPAQ-Quota-Identifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9355,'tlv','WiMAX-PPAQ',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9354,'integer','WiMAX-Session-Termination-Capability',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9353,'integer','WiMAX-Available-In-Client',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9352,'tlv','WiMAX-PPAC',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9351,'integer','WiMAX-Control-Octets-Out',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9350,'integer','WiMAX-Control-Packets-Out',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9349,'integer','WiMAX-Control-Octets-In',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9348,'integer','WiMAX-Control-Packets-In',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9347,'string','WiMAX-Uplink-Granted-QoS',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9346,'string','WiMAX-Media-Flow-Description-SDP',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9345,'short','WiMAX-Unsolicited-Polling-Interval',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9344,'short','WiMAX-SDU-Size',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9343,'short','WiMAX-Unsolicited-Grant-Interval',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9342,'byte','WiMAX-Media-Flow-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9341,'byte','WiMAX-Reduced-Resources-Code',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9340,'integer','WiMAX-Maximum-Latency',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9339,'integer','WiMAX-Tolerated-Jitter',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9338,'integer','WiMAX-Maximum-Traffic-Burst',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9337,'integer','WiMAX-Minimum-Reserved-Traffic-Rate',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9336,'integer','WiMAX-Maximum-Sustained-Traffic-Rate',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9335,'byte','WiMAX-Traffic-Priority',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9334,'byte','WiMAX-Schedule-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9333,'string','WiMAX-Service-Class-Name',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9332,'string # 6 octets','WiMAX-Global-Service-Class-Name',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9331,'byte','WiMAX-QoS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9330,'tlv','WiMAX-QoS-Descriptor',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9329,'string','WiMAX-Downlink-Classifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9328,'string','WiMAX-Uplink-Classifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9327,'byte','WiMAX-Downlink-QOS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9326,'byte','WiMAX-Uplink-QOS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9325,'byte','WiMAX-Transport-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9324,'byte','WiMAX-Activation-Trigger',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9323,'byte','WiMAX-Direction',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9322,'integer','WiMAX-Service-Profile-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9321,'short','WiMAX-Service-Data-Flow-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9320,'short','WiMAX-Packet-Data-Flow-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9319,'tlv','WiMAX-Packet-Flow-Descriptor',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9318,'short','WiMAX-SDFID',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9317,'short','WiMAX-PDFID',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9316,'byte','WiMAX-Prepaid-Indicator',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9315,'string','WiMAX-Hotline-Indicator',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9314,'integer','WiMAX-IP-Technology',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9313,'integer','WiMAX-Beginning-Of-Session',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9312,'integer','WiMAX-Session-Continue',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9311,'integer','WiMAX-RRQ-MN-HA-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9310,'octets encrypt=2','WiMAX-RRQ-MN-HA-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9309,'combo-ip','WiMAX-RRQ-HA-IP',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9308,'integer','WiMAX-HA-RK-Lifetime',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9307,'integer','WiMAX-HA-RK-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9306,'octets encrypt=2','WiMAX-HA-RK-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9305,'octets encrypt=2','WiMAX-FA-RK-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9304,'integer','WiMAX-MN-hHA-MIP6-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9303,'octets encrypt=2','WiMAX-MN-hHA-MIP6-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9302,'integer','WiMAX-MN-hHA-MIP4-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9301,'octets encrypt=2','WiMAX-MN-hHA-MIP4-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9300,'combo-ip','WiMAX-DHCPv6-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9299,'combo-ip','WiMAX-DHCPv4-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9298,'ipv6addr','WiMAX-hHA-IP-MIP6',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9297,'ipaddr','WiMAX-hHA-IP-MIP4',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9296,'octets encrypt=2','WiMAX-MSK',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9295,'octets','WiMAX-AAA-Session-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9294,'signed','WiMAX-GMT-Timezone-offset',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9293,'byte','WiMAX-Device-Authentication-Indicator',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9292,'byte','WiMAX-Idle-Mode-Notification-Cap',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9291,'byte','WiMAX-Hotlining-Capabilities',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9290,'byte','WiMAX-Accounting-Capabilities',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9289,'string','WiMAX-Release',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9288,'tlv','WiMAX-Capability',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9383,'byte','WiMAX-Idle-Mode-Transition',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9384,'octets','WiMAX-NAP-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9385,'octets','WiMAX-BS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9386,'octets','WiMAX-Location',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9387,'integer','WiMAX-Acct-Input-Packets-Gigaword',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9388,'integer','WiMAX-Acct-Output-Packets-Gigaword',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9389,'string','WiMAX-Uplink-Flow-Description',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9390,'ipv6addr','WiMAX-Blu-Coa-IPv6',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9391,'combo-ip','WiMAX-DNS-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9392,'string','WiMAX-Hotline-Profile-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9393,'string','WiMAX-HTTP-Redirection-Rule',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9394,'string','WiMAX-IP-Redirection-Rule',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9395,'integer','WiMAX-Hotline-Session-Timer',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9396,'octets','WiMAX-NSP-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9397,'integer','WiMAX-HA-RK-Key-Requested',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9398,'byte','WiMAX-Count-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9399,'integer','WiMAX-DM-Action-Code',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9400,'integer','WiMAX-FA-RK-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9401,'string','WiMAX-Downlink-Flow-Description',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9402,'tlv','WiMAX-Downlink-Granted-QoS',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9403,'ipaddr','WiMAX-vHA-IP-MIP4',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9404,'ipv6addr','WiMAX-vHA-IP-MIP6',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9405,'octets encrypt=2','WiMAX-vHA-MIP4-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9406,'octets encrypt=2','WiMAX-vHA-RK-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9407,'integer','WiMAX-vHA-RK-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9408,'integer','WiMAX-vHA-RK-Lifetime',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9409,'octets encrypt=2','WiMAX-MN-vHA-MIP6-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9410,'integer','WiMAX-MN-vHA-MIP4-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9411,'integer','WiMAX-MN-vHA-MIP6-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9412,'ipaddr','WiMAX-vDHCPv4-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
...
(9420,'integer','Access-Period',NULL,NULL,'dictionary.daloradius',':=','check',NULL,'By setting this attribute\\\'s number of seconds for a user, it allows the user to login only for the next X seconds that you have specified. In other words, unlike Max-All-Session this is NOT an accumulated time-based attribute but rather it is a Time-To-Finish.'),
(9421,'integer','Max-Weekly-Session',NULL,NULL,'dictionary.daloradius',':=','check',NULL,'Specifies the number of seconds (the counter resets weekly) for which the user may connect each week (very popular with prepaid accounts). Please notice that this attribute is internal to FreeRADIUS and is based on a respective sql module configuration in radiusd.conf'),
(9422,'integer','Max-Quaterly-Session',NULL,NULL,'dictionary.daloradius',':=','check',NULL,'Specifies the number of seconds (the counter resets quarterly) for which the user may connect each quarter of a year (very popular with prepaid accounts). Please notice that this attribute is internal to FreeRADIUS and is based on a respective sql module configuration in radiusd.conf'),
(9423,'integer','Max-Yearly-Session',NULL,NULL,'dictionary.daloradius',':=','check',NULL,'Specifies the number of seconds (the counter resets yearly) for which the user may connect each year (very popular with prepaid accounts). Please notice that this attribute is internal to FreeRADIUS and is based on a respective sql module configuration in radiusd.conf'),
(9424,'integer','CS-Total-Octets-Daily',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Total Octets attribute for limiting the total (up/down) traffic of a user. The counter resets daily.'),
(9425,'integer','CS-Total-Octets-Weekly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Total Octets attribute for limiting the total (up/down) traffic of a user. The counter resets weekly.'),
(9426,'integer','CS-Total-Octets-Monthly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Total Octets attribute for limiting the total (up/down) traffic of a user. The counter resets monthly'),
(9427,'integer','CS-Total-Octets-Quarterly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Total Octets attribute for limiting the total (up/down) traffic of a user. The counter resets quarterly.'),
(9428,'integer','CS-Total-Octets-Yearly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Total Octets attribute for limiting the total (up/down) traffic of a user. The counter resets yearly.'),
(9451,'integer','CS-Input-Octets-Yearly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Input Octets attribute for limiting the input traffic of a user. The counter resets yearly.'),
(9452,'integer','CS-Input-Octets',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Input Octets attribute for limiting the input traffic of a user. The counter never.'),
(9450,'integer','CS-Input-Octets-Quarterly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Input Octets attribute for limiting the input traffic of a user. The counter resets quarterly.'),
(9448,'integer','CS-Input-Octets-Weekly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Input Octets attribute for limiting the input traffic of a user. The counter resets weekly.'),
(9449,'integer','CS-Input-Octets-Monthly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Input Octets attribute for limiting the input traffic of a user. The counter resets monthly.'),
(9446,'integer','CS-Output-Octets-Yearly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Output Octets attribute for limiting the output traffic of a user. The counter resets yearly.'),
(9447,'integer','CS-Output-Octets',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Output Octets attribute for limiting the output traffic of a user. The counter never.'),
(9445,'integer','CS-Output-Octets-Quarterly',NULL,NULL,'dictionary.daloradius',':=','check','volumebytes','ChilliSpot Output Octets attribute for limiting the output traffic of a user. The counter resets quarterly.'),
...
(9457,'byte','WiMAX-Idle-Mode-Notification-Cap',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9458,'byte','WiMAX-Device-Authentication-Indicator',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9459,'signed','WiMAX-GMT-Timezone-offset',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9460,'octets','WiMAX-AAA-Session-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9461,'octets encrypt=2','WiMAX-MSK',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9462,'ipaddr','WiMAX-hHA-IP-MIP4',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9463,'ipv6addr','WiMAX-hHA-IP-MIP6',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9464,'combo-ip','WiMAX-DHCPv4-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9465,'combo-ip','WiMAX-DHCPv6-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9466,'octets encrypt=2','WiMAX-MN-hHA-MIP4-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9467,'integer','WiMAX-MN-hHA-MIP4-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9468,'octets encrypt=2','WiMAX-MN-hHA-MIP6-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9469,'integer','WiMAX-MN-hHA-MIP6-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9470,'octets encrypt=2','WiMAX-FA-RK-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9471,'octets encrypt=2','WiMAX-HA-RK-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9472,'integer','WiMAX-HA-RK-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9473,'integer','WiMAX-HA-RK-Lifetime',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9474,'combo-ip','WiMAX-RRQ-HA-IP',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9475,'octets encrypt=2','WiMAX-RRQ-MN-HA-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9476,'integer','WiMAX-RRQ-MN-HA-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9477,'integer','WiMAX-Session-Continue',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9478,'integer','WiMAX-Beginning-Of-Session',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9479,'integer','WiMAX-IP-Technology',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9480,'string','WiMAX-Hotline-Indicator',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9481,'byte','WiMAX-Prepaid-Indicator',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9482,'short','WiMAX-PDFID',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9483,'short','WiMAX-SDFID',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9484,'tlv','WiMAX-Packet-Flow-Descriptor',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9485,'short','WiMAX-Packet-Data-Flow-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9486,'short','WiMAX-Service-Data-Flow-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9487,'integer','WiMAX-Service-Profile-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9488,'byte','WiMAX-Direction',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9489,'byte','WiMAX-Activation-Trigger',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9490,'byte','WiMAX-Transport-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9491,'byte','WiMAX-Uplink-QOS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9492,'byte','WiMAX-Downlink-QOS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9493,'string','WiMAX-Uplink-Classifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9494,'string','WiMAX-Downlink-Classifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9495,'tlv','WiMAX-QoS-Descriptor',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9496,'byte','WiMAX-QoS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9497,'string # 6 octets','WiMAX-Global-Service-Class-Name',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9498,'string','WiMAX-Service-Class-Name',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9499,'byte','WiMAX-Schedule-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9500,'byte','WiMAX-Traffic-Priority',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9501,'integer','WiMAX-Maximum-Sustained-Traffic-Rate',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9502,'integer','WiMAX-Minimum-Reserved-Traffic-Rate',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9503,'integer','WiMAX-Maximum-Traffic-Burst',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9504,'integer','WiMAX-Tolerated-Jitter',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9505,'integer','WiMAX-Maximum-Latency',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9506,'byte','WiMAX-Reduced-Resources-Code',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9507,'byte','WiMAX-Media-Flow-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9508,'short','WiMAX-Unsolicited-Grant-Interval',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9509,'short','WiMAX-SDU-Size',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9510,'short','WiMAX-Unsolicited-Polling-Interval',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9511,'string','WiMAX-Media-Flow-Description-SDP',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9512,'string','WiMAX-Uplink-Granted-QoS',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9513,'integer','WiMAX-Control-Packets-In',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9514,'integer','WiMAX-Control-Octets-In',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9515,'integer','WiMAX-Control-Packets-Out',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9516,'integer','WiMAX-Control-Octets-Out',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9517,'tlv','WiMAX-PPAC',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9518,'integer','WiMAX-Available-In-Client',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9519,'integer','WiMAX-Session-Termination-Capability',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9520,'tlv','WiMAX-PPAQ',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9521,'octets','WiMAX-PPAQ-Quota-Identifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9522,'integer #kb','WiMAX-Volume-Quota',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9523,'integer #kb','WiMAX-Volume-Threshold',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9524,'integer #s','WiMAX-Duration-Quota',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9525,'integer #s','WiMAX-Duration-Threshold',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9526,'integer','WiMAX-Resource-Quota',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9527,'integer','WiMAX-Resource-Threshold',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9528,'integer','WiMAX-Update-Reason',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9529,'combo-ip','WiMAX-Prepaid-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9530,'string','WiMAX-Service-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9531,'integer','WiMAX-Rating-Group-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9532,'byte','WiMAX-Termination-Action',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9533,'integer','WiMAX-Pool-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9534,'integer','WiMAX-Pool-Multiplier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9535,'byte','WiMAX-Requested-Action',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9536,'byte','WiMAX-Check-Balance-Result',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9537,'octets','WiMAX-Cost-Information-AVP',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9538,'tlv','WiMAX-Prepaid-Tariff-Switching',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9539,'string','WiMAX-Prepaid-Quota-Identifier',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9540,'integer #1k','WiMAX-Volume-Used-After',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9541,'integer #s','WiMAX-Tariff-Switch-Interval',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9542,'integer #s','WiMAX-Time-Interval-After',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9543,'integer','WiMAX-Active-Time-Duration',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9544,'octets encrypt=2','WiMAX-DHCP-RK',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9545,'integer','WiMAX-DHCP-RK-Key-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9546,'integer','WiMAX-DHCP-RK-Lifetime',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9547,'ipaddr','WiMAX-DHCP-Msg-Server-IP',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9548,'byte','WiMAX-Idle-Mode-Transition',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9549,'octets','WiMAX-NAP-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9550,'octets','WiMAX-BS-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9551,'octets','WiMAX-Location',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9552,'integer','WiMAX-Acct-Input-Packets-Gigaword',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9553,'integer','WiMAX-Acct-Output-Packets-Gigaword',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9554,'string','WiMAX-Uplink-Flow-Description',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9555,'ipv6addr','WiMAX-Blu-Coa-IPv6',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9556,'combo-ip','WiMAX-DNS-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9557,'string','WiMAX-Hotline-Profile-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9558,'string','WiMAX-HTTP-Redirection-Rule',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9559,'string','WiMAX-IP-Redirection-Rule',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9560,'integer','WiMAX-Hotline-Session-Timer',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9561,'octets','WiMAX-NSP-Id',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9562,'integer','WiMAX-HA-RK-Key-Requested',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9563,'byte','WiMAX-Count-Type',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9564,'integer','WiMAX-DM-Action-Code',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9565,'integer','WiMAX-FA-RK-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9566,'string','WiMAX-Downlink-Flow-Description',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9567,'tlv','WiMAX-Downlink-Granted-QoS',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9568,'ipaddr','WiMAX-vHA-IP-MIP4',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9569,'ipv6addr','WiMAX-vHA-IP-MIP6',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9570,'octets encrypt=2','WiMAX-vHA-MIP4-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9571,'octets encrypt=2','WiMAX-vHA-RK-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9572,'integer','WiMAX-vHA-RK-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9573,'integer','WiMAX-vHA-RK-Lifetime',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9574,'octets encrypt=2','WiMAX-MN-vHA-MIP6-Key',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9575,'integer','WiMAX-MN-vHA-MIP4-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9576,'integer','WiMAX-MN-vHA-MIP6-SPI',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
(9577,'ipaddr','WiMAX-vDHCPv4-Server',NULL,NULL,'dictionary.wimax',NULL,NULL,NULL,NULL),
...
(9602,'octets encrypt=2','WiMAX-FA-RK-Key',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9603,'octets encrypt=2','WiMAX-HA-RK-Key',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9604,'integer','WiMAX-HA-RK-SPI',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9605,'integer','WiMAX-HA-RK-Lifetime',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9606,'combo-ip','WiMAX-RRQ-HA-IP',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9607,'octets encrypt=2','WiMAX-RRQ-MN-HA-Key',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9608,'tlv','WiMAX-Time-Of-Day-Time',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9609,'byte','WiMAX-Hour',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9610,'byte','WiMAX-Minute',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9611,'integer','WiMAX-UTC-Offset',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9612,'integer','WiMAX-Session-Continue',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9613,'integer','WiMAX-Beginning-Of-Session',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9614,'integer','WiMAX-IP-Technology',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9615,'string','WiMAX-Hotline-Indicator',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9616,'byte','WiMAX-Prepaid-Indicator',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9617,'short','WiMAX-PDFID',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9618,'short','WiMAX-SDFID',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9619,'tlv','WiMAX-Packet-Flow-Descriptor',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9620,'short','WiMAX-Packet-Data-Flow-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9621,'short','WiMAX-Service-Data-Flow-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9622,'integer','WiMAX-Service-Profile-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9623,'byte','WiMAX-Direction',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9624,'byte','WiMAX-Activation-Trigger',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9625,'byte','WiMAX-Transport-Type',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9626,'byte','WiMAX-Uplink-QOS-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9627,'byte','WiMAX-Downlink-QOS-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9628,'string','WiMAX-Uplink-Classifier',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9629,'string','WiMAX-Downlink-Classifier',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9630,'tlv','WiMAX-QoS-Descriptor',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9631,'byte','WiMAX-QoS-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9632,'string # 6 octets','WiMAX-Global-Service-Class-Name',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9633,'string','WiMAX-Service-Class-Name',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9634,'byte','WiMAX-Schedule-Type',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9635,'byte','WiMAX-Traffic-Priority',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9636,'integer','WiMAX-Maximum-Sustained-Traffic-Rate',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9637,'integer','WiMAX-Minimum-Reserved-Traffic-Rate',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9638,'integer','WiMAX-Maximum-Traffic-Burst',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9639,'integer','WiMAX-Tolerated-Jitter',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9640,'integer','WiMAX-Maximum-Latency',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9641,'byte','WiMAX-Reduced-Resources-Code',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9642,'byte','WiMAX-Media-Flow-Type',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9643,'short','WiMAX-Unsolicited-Grant-Interval',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9644,'short','WiMAX-SDU-Size',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9645,'short','WiMAX-Unsolicited-Polling-Interval',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9646,'string','WiMAX-Media-Flow-Description-SDP',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9647,'tlv','WiMAX-Uplink-Granted-QoS',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9648,'integer','WiMAX-Control-Packets-In',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9649,'integer','WiMAX-Control-Octets-In',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9650,'integer','WiMAX-Control-Packets-Out',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9651,'integer','WiMAX-Control-Octets-Out',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9652,'tlv','WiMAX-PPAC',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9653,'integer','WiMAX-Available-In-Client',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9654,'integer','WiMAX-Session-Termination-Capability',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9655,'tlv','WiMAX-PPAQ',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9656,'octets','WiMAX-PPAQ-Quota-Identifier',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9657,'integer #kb','WiMAX-Volume-Quota',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9658,'integer #kb','WiMAX-Volume-Threshold',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9659,'integer #s','WiMAX-Duration-Quota',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9660,'integer #s','WiMAX-Duration-Threshold',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9661,'integer','WiMAX-Resource-Quota',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9662,'integer','WiMAX-Resource-Threshold',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9663,'integer','WiMAX-Update-Reason',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9664,'combo-ip','WiMAX-Prepaid-Server',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9665,'string','WiMAX-Service-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9666,'integer','WiMAX-Rating-Group-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9667,'byte','WiMAX-Termination-Action',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9668,'integer','WiMAX-Pool-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9669,'integer','WiMAX-Pool-Multiplier',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9670,'byte','WiMAX-Requested-Action',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9671,'byte','WiMAX-Check-Balance-Result',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9672,'octets','WiMAX-Cost-Information-AVP',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9673,'tlv','WiMAX-Prepaid-Tariff-Switching',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9674,'string','WiMAX-Prepaid-Quota-Identifier',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9675,'integer #1k','WiMAX-Volume-Used-After',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9676,'integer #s','WiMAX-Tariff-Switch-Interval',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9677,'integer #s','WiMAX-Time-Interval-After',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9678,'integer','WiMAX-Active-Time-Duration',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9679,'octets encrypt=2','WiMAX-DHCP-RK',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9680,'integer','WiMAX-DHCP-RK-Key-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9681,'integer','WiMAX-DHCP-RK-Lifetime',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9682,'ipaddr','WiMAX-DHCP-Msg-Server-IP',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9683,'byte','WiMAX-Idle-Mode-Transition',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9684,'octets','WiMAX-NAP-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9685,'octets','WiMAX-BS-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9686,'octets','WiMAX-Location',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9687,'integer','WiMAX-Acct-Input-Packets-Gigaword',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9688,'integer','WiMAX-Acct-Output-Packets-Gigaword',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9689,'string','WiMAX-Uplink-Flow-Description',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9690,'ipv6addr','WiMAX-BU-CoA-IPv6',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9691,'combo-ip','WiMAX-DNS-Server',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9692,'string','WiMAX-Hotline-Profile-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9693,'string','WiMAX-HTTP-Redirection-Rule',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9694,'string','WiMAX-IP-Redirection-Rule',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9695,'integer','WiMAX-Hotline-Session-Timer',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9696,'octets','WiMAX-NSP-Id',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9697,'integer','WiMAX-HA-RK-Key-Requested',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9698,'byte','WiMAX-Count-Type',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9699,'integer','WiMAX-DM-Action-Code',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9700,'integer','WiMAX-FA-RK-SPI',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9701,'string','WiMAX-Downlink-Flow-Description',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9702,'tlv','WiMAX-Downlink-Granted-QoS',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9703,'ipaddr','WiMAX-vHA-IP-MIP4',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9704,'ipv6addr','WiMAX-vHA-IP-MIP6',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9705,'octets encrypt=2','WiMAX-vHA-MIP4-Key',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9706,'octets encrypt=2','WiMAX-vHA-RK-Key',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9707,'integer','WiMAX-vHA-RK-SPI',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9708,'integer','WiMAX-vHA-RK-Lifetime',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9709,'octets encrypt=2','WiMAX-MN-vHA-MIP6-Key',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9710,'integer','WiMAX-MN-vHA-MIP4-SPI',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9711,'integer','WiMAX-MN-vHA-MIP6-SPI',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
(9712,'ipaddr','WiMAX-vDHCPv4-Server',NULL,NULL,'dictionary.wimax.wichorus',NULL,NULL,NULL,NULL),
...
(1,'168.148.62.99','','other',0,'0004800048','','','');
...
(6,'administrator','ll0decr\'gr=i#62@62','','','','','','','','','','','','','2026-02-05 15:07:03','2009-12-07 20:12:33','admin','2024-07-08 15:27:55','administrator');
...
INSERT INTO `operators_acl_files` VALUES
...
(3,'daloRADIUS-Disabled-Users','Auth-Type',':=','Reject');
